...
$env:PHONE_DINO_ARTIFACT_MANIFEST = (Resolve-Path "$PSScriptRoot\runtime\engineering-real-dino\engineering-real-dino-artifact-v18.json").Path
$env:PHONE_DINO_ARTIFACT_PACKAGE_DIGEST = "sha256:ddfb5213d1efbce6aefee4d85efdf16273299a6f7fe4ed95b300eefbbcd7b637"
