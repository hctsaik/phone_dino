...
完整 scorer contract 見 [Golden 主體分割與背景抑制設計](golden_subject_segmentation_design.md)；現行 runtime/artifact pin 為 PhoneDINO 0.7.6、schema 1.8、v21，Golden ID 為 `GOLDEN-ACTIVE-V19-4FBB2AEE`。
