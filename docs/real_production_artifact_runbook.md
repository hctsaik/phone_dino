...
The repository now contains the schema-1.8 engineering v17 artifact for `PM-ABC-001`, bound to Phone Dino 0.7.1 runtime digest `sha256:ee726620f17c7fc8e730f3ba240f4687f2af89c3e5b1beb46bb8223952aec723` and artifact digest `sha256:7d1256e66a6be99c564b648d4b88dfc026e3215f3215862ff4b97bd12d8542ef`, with a real DINOv2 model, a real MobileSAM-compiled Golden subject mask, pinned Current subject segmentation, and the fail-closed Golden dimension baseline capability. Its subject-mask digest `sha256:073bfe5037a19b13cc072c617f7a2bd648e9be78d9b91b05bde400256db0905f`, ROI digest `sha256:49e89b6adbc8202c2b79575e6e61b0b45601666e0fe0ee277691055ee6f67514`, scorer-input digest `sha256:93e19e1f6cd0ec25c4011e7218eea8aa24e12cbcef9419646d5afe5abd936b66`, and recipe-profile digest `sha256:4eb9b0823328728bbbb1898070903d989d5541c8deee9bfaab69bc2af2853def` are pinned across both services. Startup precomputes immutable Golden ROI patch embeddings and each request reuses its Current scorer tile embeddings for spatial evidence. The compiled Golden ID intentionally retains the V10 lineage; the active runtime/artifact identity is v17. It remains `ENGINEERING_AUTO` and `productionAuthorized=false`; this is not a signed production artifact. The remaining production work is physical data qualification, blind evaluation, approval, and pin promotion—not another model download. See [Golden 主體分割與背景抑制設計](golden_subject_segmentation_design.md) for the scorer contract and upgrade/rollback rules.
